...
//Snake Eating
    ...
    {
        foodsound.play();
        snakebody.unshift({x: snakebody[0].x +velocity.x,y: snakebody[0].y +velocity.y})//Food Eating Check
        let a=5;
        let b=20;
        food=generatefood();
        score++;
...
//SNAKE DISPLAY
    ...
    {
       snakeelement=document.createElement("element");
...
//FOOD DISPLAY
    foodelement=document.createElement("element");
